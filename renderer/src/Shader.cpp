...
void Shader::setUniformVec3f(const std::string& name, const glm::vec3& vector) const
{
	int location = getUniformLocation(name);
	if (location != -1)
...
void Shader::setUniform3fv(const std::string& name, const std::vector<glm::vec3>& vector, int count) const
{
	int location = getUniformLocation(name);
	if (location != -1)
